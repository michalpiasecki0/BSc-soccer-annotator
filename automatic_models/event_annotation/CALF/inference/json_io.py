...
from automatic_models.event_annotation.CALF.inference.config.classes import \
    EVENT_DICTIONARY_V2, INVERSE_EVENT_DICTIONARY_V2

def predictions2json(predictions_half_1, output_path, framerate=2, confidence_threshold = 0.7):
